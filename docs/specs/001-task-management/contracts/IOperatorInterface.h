...
// Forward declaration for Task entity DTO
struct TaskDto;
...
// Simple DTO for Task information (re-declared or included from ITaskManager.h if shared)
// For simplicity, re-declaring here. In a real project, this would be in a common header.
struct TaskDto {
    std::string id;
    std::string name;
    std::string type;
